  ...
  return (
    <div className="space-y-2">
      {preview ? (
        ...
        <div
          className="border-muted-foreground/75 grid h-50 w-full cursor-pointer place-items-center rounded-xl border border-dashed"
          role="button"
          tabIndex={0}
          onClick={openWidget}
          onKeyDown={(event) => {
        ...
        >
          <div className="flex flex-col items-center">
            <UploadCloud className="mb-2 size-12" />
            <div>
